...
export default function Footer({ navigate }: FooterProps) {
  ...
  return (
    <footer className="w-full bg-slate-50 dark:bg-zinc-950/80 border-t border-slate-200/60 dark:border-zinc-800/60 mt-16 transition-all duration-300 hidden sm:block">
