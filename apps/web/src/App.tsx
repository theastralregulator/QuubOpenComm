              ...
              {showAuthModal === 'signin' && (
                ...
                <div className="space-y-4 text-left">
                  ...
                  <div className="relative flex items-center justify-center my-4">
                    ...
                    <span className="bg-white dark:bg-zinc-900 px-3 text-[11px] text-slate-400 font-medium shrink-0">
                      ...
                      if (supabase) {
                        try {
                          ...
                          if (error) {
                            ...
                            if (data.user?.id) {
                              const freshProf = await dbService.getProfile(data.user.id);
                              if (freshProf) {
                                setCurrentProfileObj(freshProf);
                                isComplete = freshProf.onboarding_completed === true;
