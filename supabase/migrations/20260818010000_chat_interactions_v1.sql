...
BEGIN
  IF TG_OP = 'UPDATE' THEN
    ...
    IF NEW.conversation_id IS DISTINCT FROM OLD.conversation_id THEN
      RAISE EXCEPTION 'Cannot modify conversation_id of an existing reaction.';
    END IF;
...
BEGIN
  ...
  -- Document: Max 20MB (20971520 bytes), preview_text = 'Document', PDF/DOCX/XLSX/PPTX/TXT/CSV permitted
